...
function App() {
    ...
    const getWeather = async (location) => {
        ...
        try {
            let res = await fetch(
                `${process.env.REACT_APP_URL + how_to_search}&appid=${API_KEY}&units=metric&cnt=5&exclude=hourly,minutely`
            );
    ...
    return (
        <div className="bg-gray-800 flex items-center justify-center w-auto h-screen min-h-max py-10 ">
            <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
                ...
                <div className="form-container">
                    ...
                    <div className="flex flex-col items-center justify-center h-full">
                        <h1 className="text-white text-2xl">The Only Weather Forecat App You Need</h1>
