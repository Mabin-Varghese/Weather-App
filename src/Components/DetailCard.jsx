...
function DetailCard({ weather_icon, data }) {
    const { clouds, weather, main } = data.list[0];
    return (
        <div className="container p-4 flex justify-center items-center shadow-lg rounded-lg bg-white h-1/3 mb-auto">
            <div className="my-auto">
                ...
                <p className="text-4xl text-gray-800 tracking-widest">
                    {weather[0].main}
                    <img src={weather_icon} className="w-1/3 inline" alt="icon" />
                </p>
                <p className="text-gray-400 text-xs uppercase tracking-widest">{weather[0].discription}</p>
